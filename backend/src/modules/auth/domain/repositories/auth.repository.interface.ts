...
export interface IAuthRepository {
  ...
  countByRole(filters: { search?: string; status?: UserStatus }): Promise<Record<UserRole, number>>;
  countByStatus(filters: { search?: string; role?: UserRole }): Promise<Record<UserStatus, number>>;
